  ...
  <div v-if="announcement">
    <div class="student-class flex flex-col items-center justify-center">
      <div class="grid gap-5 grid-cols-2 p-3 w-3/4 h-4/5 border border-gray-700
        ...
        <div class="my-auto">
          <span class="text-base text-gray-500 text-md font-semibold font-fig">Dish: </span> <br />
          ...
          <span class="text-base text-black text-md font-fig">Ingredient: {{ announcement.recipeIngredientParts }}</span> <br />
          <span class="text-base text-black text-md font-fig">Quantity: {{ announcement.recipeIngredientQuantities }}</span> <br />
          <span class="text-base text-black text-md font-fig">Instructions: {{ announcement.recipeInstructions }}</span>
